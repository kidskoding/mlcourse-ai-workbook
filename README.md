...
Notebooks are [marimo](https://marimo.io) `.py` files. You need [uv](https://docs.astral.sh/uv/); everything else installs from the lockfile.

```sh
uv sync

# open a notebook (browser tab; --watch picks up edits made outside marimo)
